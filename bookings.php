<!-- Author: Nathan Shava
     ...
     Filename: bookings.php
-->
<?php
require_once 'connect.php'; //File used to establish connection to the database
session_start();
...
<section class="bg0 p-t-85 p-b-45">
    <div class="container">
        <form id="bookingsForm" name="bookingsForm" target="_self" method="post" action="makebooking.php">
            <div class="form-group">
                <label for="firstname">
                    First Name: <span class="cl12">*</span>
                </label>

                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1" id="firstname" type="text"
            ...
            <div class="form-group">
                ...
                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1" id="lastname" type="text"
            ...
            <div class="form-group">
                <label for="contact">
                    Contact Number: <span class="cl12">*</span>
                </label>

                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1" id="contact" type="text"
                       name="contact" placeholder="e.g. 071-100-1000" pattern="\d{3}-?\d{3}-?\d{4}" title="XXX-XXX-XXXX"
                       required>
            </div>
            <br/>
            ...
            <div class="form-group">
                ...
                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1" type="email" id="emailAdd"
                       name="emailAdd" placeholder="username@mail.com" required>
            </div>

            <div class="form-group">
                <label for="appointmentdate">
                    Appointment Date: <span class="cl12">*</span>
                </label>

                <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-20 focus1" id="appointmentdate" type="date"
                       name="appointmentdate" min="<?php echo date("Y-m-d"); ?>" required>
            </div>

            <div class="form-group">
                <label for="services">
                    Service Description: <span class="cl12">*</span>
                </label>

                <select class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="text" id="services"
                    ...
                    <option value="Hair dressing">Hair dressing appointment</option>
                    <option value="Make up">Make up</option>
                    <option value="Make up and nails">Make up and nails</option>
                    <option value="Massage therapy">Massage therapy</option>
                </select>
            </div>

            <div class="form-group" style="margin-top:5%;">
                <button id="btnBooking" name="btnBooking" type="button" onclick="validateBooking()"
...
<script type="text/javascript" language="JavaScript">
    ...
    function validateBooking() {
        ...
        var validateFirstname = validatedFirstname();
        var validateLastname = validatedLastname();
        var validateContact = validatedContact();
        var validateEmail = validatedEmail();
        var validateDate = validatedDate();
        var validateService = validatedServices();

        if (validateFirstname && validateLastname && validateContact && validateEmail && validateDate && validateService) {

            document.bookingsForm.submit();
            document.bookingsForm.reset();
        }
    ...
    function validatedFirstname() {
        ...
        var firstname = document.bookingsForm.firstname.value;
        var action;
    ...
    function validatedLastname() {
        ...
        var lastname = document.bookingsForm.lastname.value;
        var action;
    ...
    function validatedContact() {
        ...
        var contact = document.bookingsForm.contact.value;
        var action;
    ...
    function validatedEmail() {
        ...
        var email = document.bookingsForm.emailAdd.value;
        var action;
    ...
    function validatedDate() {
        ...
        var date = document.bookingsForm.appointmentdate.value;
        var action;

        if (date === ""){

            document.getElementById("appointmentdate").style.borderColor = "#ff0000";
            action = false;
        }
        else {
            document.getElementById("appointmentdate").style.borderColor = "";
            action = true;
        }
    ...
    function validatedServices() {
        ...
        var service = document.bookingsForm.services.value;
        var action;

        if (service === ""){

            document.getElementById("services").style.borderColor = "#ff0000";
            action = false;
        }
        else {
