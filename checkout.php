    ...
    <div class="container">
        ...
        <div>
            ...
            <div class="how-bor3 p-rl-15 p-tb-28 m-tb-33 dis-none js-panel1">
                <div class="container">
                    <form id="checkoutLoginFrm" name="checkoutLoginFrm" method="post"
                          action="customer_login.php" target="_self">

                        <p class="txt-s-120 cl9 txt-center p-b-26" style="color:#000000;">
                        ...
                        <div class="row">
                            <div class="col-sm-6 p-b-20">
                                <div class="form-group">
                                    ...
                                    <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="email"
                                           name="loginEmailAdd" id="loginEmailAdd">
                                </div>
                            </div>
                            ...
                            <div class="col-12 form-group">
                                <button class="flex-c-m txt-s-105 cl0 bg10 size-a-21 hov-btn2 trans-04 p-rl-10"
                                        id="btnLogin" name="btnLogin" onclick="validateLogin()" type="button">
                                    Login
                                </button>

                                <a href="resetpass.php" class="txt-s-101 cl9 hov-cl10 trans-04" style="margin-top:5%;">
                                    Lost your password?
                                </a>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-5 col-lg-4 p-b-50">
                <div class="how-bor4 p-t-35 p-b-40 p-rl-30 m-t-5" style="margin-top:10%;">
                    <form method="post" target="_self" name="checkoutForm" id="checkoutForm" action="#">
                        ...
                        <div class="bo-all-1 bocl15 p-b-25 m-b-30">
                            <div class="flex-w flex-m bo-b-1 bocl15 p-rl-20 p-tb-16">
                                <input class="m-r-15" id="radioCash" type="radio" name="pay" value="Cash"
                                       checked="checked">
                                <label class="txt-m-103 cl6" for="radioCash">
                                    Cash on Delivery
                                </label>
                            </div>
                            ...
                            <div class="content-payment bo-b-1 bocl15 p-rl-20 p-tb-15">
                                <p class="txt-s-120 cl9">
                                    Please ensure you have enough cash on hand and preferably small denominations as the
                                    delivery man may not have enough change on hand
                                </p>
                            </div>

                            <div class="flex-w flex-m p-rl-20 p-t-17 p-b-10">
                                <input class="m-r-15" id="radioPayPal" type="radio" name="pay" value="paypal">
                                <label class="txt-m-103 cl6" for="radioPayPal">
                                    Paypal/Credit Card
                                </label>
                        ...
                        <button class="flex-c-m txt-s-105 cl0 bg10 size-a-21 hov-btn2 trans-04 p-rl-10" type="button"
                                id="btnOrder" name="btnOrder" onclick="placeOrder()">
                            Place order
                        </button>
                    </form>
                </div>
...
<script type="text/javascript" language="JavaScript">
    ...
    function validateLogin() {
        ...
        if ((emailValidated === true) && (pwdValidated === true)) {
            ...
            document.checkoutLoginFrm.submit();
            document.checkoutLoginFrm.reset();
        }
    }

    function validateLoginEmail() {

        var emailAddress = document.checkoutLoginFrm.loginEmailAdd.value;
        var action;
    ...
    function validateLoginPwd() {
        ...
        var loginPwd = document.checkoutLoginFrm.loginPwd.value;
        var action;
