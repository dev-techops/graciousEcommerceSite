<!-- Author: Nathan Shava
     ...
     Description: Customer Reg/Login
     Filename: client_reg_login.php
-->
<?php
        ...
        <div class="row">
            <div class="col-md-6 p-b-50">
                <div class="p-r-15 p-rl-0-lg">
                    ...
                    <form name="loginFrm" id="loginFrm" method="post" target="_self"
                          action="customer_login.php">
                        <div class="form-group">
                            <label for="loginEmailAdd">
                                Email address: <span class="cl12">*</span>
                            </label>

                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="email"
                                   id="loginEmailAdd" name="loginEmailAdd" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="password"
                                   id="loginPwd" name="loginPwd" required>
                        </div>

                        <div class="form-group">
                            <button class="flex-c-m txt-s-105 cl0 bg10 size-a-39 hov-btn2 trans-04 p-rl-10 m-r-18"
                                    onclick="validateLogin()" name="btnLogin" type="button">
                                Login
                            </button>
                        </div>

                        <a href="resetpass.php" class="txt-s-101 cl9 hov-cl10 trans-04">
                            Lost your password?
                        </a>
                    </form>
                </div>
            ...
            <div class="col-md-6 p-b-50">
                <div class="container">
                    ...
                    <form id="customerRegForm" name="customerRegForm"
                          target="_self" method="post" action="customer_reg.php">
                        ...
                        <div class="form-group">
                            ...
                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="email"
                                   id="emailAdd" name="emailAdd" required>
                        </div>

                        <div class="form-group">
                            <label for="streetAdd">
                                Street Address <span class="cl12">*</span>
                            </label>

                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="text"
                                   id="streetAdd" name="streetAdd" required>
                        </div>

                        <div class="form-group">
                            <label for="suburb">
                                Suburb <span class="cl12">*</span>
                            </label>
                        ...
                        <div class="form-group">
                            ...
                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="text" id="city"
                                   name="city" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="text" id="province"
                        ...
                        <div class="form-group">
                            ...
                            <input class="txt-s-120 cl3 size-a-21 bo-all-1 bocl15 p-rl-15 focus1" type="password"
                                   id="confPwd" name="confPwd" required>
                        </div>

                        <div class="form-group">
                            <button onclick="validateReg()" type="button" name="btnReg" id="btnReg"
...
<script type="text/javascript" language="JavaScript">
    ...
    function validateReg() {
        ...
        var validatedFname = validateFname();
        var validatedLname = validateLname();
        var validatedContact = validateContact();
        var validatedAddr = validateAddr();
        var validatedCity = validateCity();
        var validatedProv = validateProv();
        var validatedEmail = validateEmail();
        var validatedPwd = validatePwd();

        if (validatedFname && validatedLname && validatedContact && validatedAddr && validatedCity && validatedProv
            && validatedEmail && validatedPwd) {

            document.customerRegForm.submit();
            document.customerRegForm.reset();
        }
    ...
    function validateFname() {
        ...
        var fname = document.customerRegForm.firstname.value;
        var action;
    ...
    function validateLname() {
        ...
        var lname = document.customerRegForm.lastname.value;
        var action;
    ...
    function validateContact() {
        ...
        var contact = document.customerRegForm.contact.value;
        var action;
    ...
    function validateAddr() {
        ...
        var address = document.customerRegForm.streetAdd.value;
        var action;

        if (address === "") {

            document.getElementById("streetAdd").style.borderColor = "#ff0000";
            action = false;

        }
        else {

            document.getElementById("streetAdd").style.borderColor = "";
            action = true;
        }
    ...
    function validateCity() {
        ...
        var cty = document.customerRegForm.city.value;
        var action;
    ...
    function validateProv() {
        ...
        var cty = document.customerRegForm.province.value;
        var action;
    ...
    function validateEmail() {
        ...
        var email = document.customerRegForm.emailAdd.value;
        var action;

        if (email === "") {

            document.getElementById("emailAdd").style.borderColor = "#ff0000";
            action = false;

        }
        else {

            document.getElementById("emailAdd").style.borderColor = "";
            action = true;
        }
    ...
    function validatePwd() {
        ...
        var pwd = document.customerRegForm.pwd.value;
        var confPwd = document.customerRegForm.confPwd.value;
        var action;
    ...
    function validateLogin() {
        ...
        var emailValidated = validateLoginEmail();
        var pwdValidated = validateLoginPwd();

        if ((emailValidated === true) && (pwdValidated === true)) {
    ...
    function validateLoginEmail() {
        ...
        var emailAddress = document.loginFrm.loginEmailAdd.value;
        var action;

        if (emailAddress === "") {
            document.getElementById("loginEmailAdd").style.borderColor = "#ff0000";
            action = false;
        }
        else {
            document.getElementById("loginEmailAdd").style.borderColor = "";
            action = true;
        }
    ...
    function validateLoginPwd() {
        ...
        var loginPwd = document.loginFrm.loginPwd.value;
        var action;

        if (loginPwd === "") {
            document.getElementById("loginPwd").style.borderColor = "#ff0000";
            action = false;
        }
        else {
