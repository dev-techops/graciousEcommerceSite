                                ...
                                if (isset($_POST["btnAddCartItem"])) {
                                    ...
                                    if (isset($_SESSION["shoppingCart"])) //Keeps track of the shopping cart
                                    {
                                        ...
                                        if (!in_array($_GET["cartProd"], $array_item_id)) {
                                            ...
                                            ?>
                                            <script>
                                                window.location.href = "conditioners.php"; //Refresh page
                                            </script>
                                            <?php
                                    ...
                                    if ($_GET["action"] == "remove") //When customer clicks on the delete icon in the cart
                                    {
                                        foreach ($_SESSION["shoppingCart"] as $items => $values) {
                                            if ($values["product_item"] == $_GET["removeFromCart"]) {
                                                ...
                                                ?>
                                                <script>
                                                    window.location.href = "conditioners.php"; //Refresh
                                                </script>
                                                <?php
                                            }
                                        }
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc1['product_id']; ?>">
                    ...
                    while ($hc2 = mysqli_fetch_assoc($hairConditioner2)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc2['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc3 = mysqli_fetch_assoc($hairConditioner3)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc3['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc4 = mysqli_fetch_assoc($hairConditioner4)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc4['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc5 = mysqli_fetch_assoc($hairConditioner5)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc5['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc6 = mysqli_fetch_assoc($hairConditioner6)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc6['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc7 = mysqli_fetch_assoc($hairConditioner7)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc7['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc8 = mysqli_fetch_assoc($hairConditioner8)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc8['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc9 = mysqli_fetch_assoc($hairConditioner9)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc9['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hc10 = mysqli_fetch_assoc($hairConditioner10)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="conditioners.php?action=add&cartProd=<?php echo $hc10['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
