    ...
    <div class="row">
        <div class="col-sm-10 col-md-6 col-lg-5 m-rl-auto p-b-10">
            <div class="h-full how5 m-r--30 m-r-0-lg m-l-15-xl">
                <div class="bg-img3 h-full respon18"
                     style="background-image: url(images/salon_img/salon_details.jpg);width:450px;height:620px;"></div>
            </div>
        </div>
        ...
        <div class="col-sm-10 col-md-6 col-lg-7 m-rl-auto p-b-10">
            <div class="p-t-75 p-l-70 p-rl-0-lg">
                ...
                <form id="feedbackForm" method="post" action="feedback.php" name="feedbackForm">
                    <div class="row">
                        <div class="col-lg-6 p-b-20">
                            <div class="m-r--5 m-rl-0-lg validate-input" data-validate="Name is required">
                                <input style="color:#262626;" class="txt-s-115 cl3 plh1 size-a-25 bo-all-1 bocl15 focus1 p-rl-20" type="text"
                                       name="fullName" id="fullName" placeholder="Your Full Name *">
                            </div>
                        </div>

                        <div class="col-lg-6 p-b-20">
                            <div class="m-l--5 m-rl-0-lg validate-input"
                                 data-validate="Valid email is: username@mail.com">
                                <input style="color:#262626;" class="txt-s-115 cl3 plh1 size-a-25 bo-all-1 bocl15 focus1 p-rl-20" type="email"
                                       name="emailAdd" id="emailAdd" placeholder="Your Email address">
                            </div>
                        </div>

                        <div class="col-lg-6 p-b-20">
                            <div class="m-l--5 m-rl-0-lg validate-input"
                                 data-validate="Please enter a valid phone number">
                                <input style="color:#262626;" class="txt-s-115 cl3 plh1 size-a-25 bo-all-1 bocl15 focus1 p-rl-20" type="text"
                                       name="contact" id="contact" placeholder="e.g 083 600 6000">
                            </div>
                        </div>

                        <div class="col-12 p-b-20">
                            <div class="validate-input" data-validate="Please enter a message">
                                <textarea style="color:#262626;" class="txt-s-115 cl3 plh1 size-a-48 bo-all-1 bocl15 focus1 p-rl-20 p-tb-10"
                                          name="feedbackMsg" id="feedbackMsg" placeholder="Your Message"></textarea>
                            </div>
                        </div>
                    </div>

                    <div class="flex-l p-t-10">
                        <button type="button" name="btnSend" id="btnSend" onclick="validateForm()"
...
<section class="how-pos2-parent">
    <div class="map how-pos2 s-full respon19">
        <div class="contact-map h-full" id="map_gracious" data-map-x="-33.943790" data-map-y="18.468910"
...
<!--===============================================================================================-->
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBEDrHZ3E4IylQC71AoAEjedKF2NOqlMl8&callback=initMap">
</script>
<script src="js/gracious_map.js"></script>
<!--===============================================================================================-->
...
<script type="text/javascript" language="JavaScript">
    ...
    function validateForm() {
        ...
        var validateName = validatedName();
        var validateMsg = validatedMsg();
        var validateContact = validatedContact();
        var validateEmail = validatedEmail();

        if (validateName && validateEmail && validateContact && validateMsg) {
    ...
    function validatedName() {
        ...
        var firstname = document.feedbackForm.fullName.value;
        var action;
    ...
    function validatedEmail() {
        ...
        var email = document.feedbackForm.emailAdd.value;
        var action;
    ...
    function validatedMsg() {

        var lastname = document.feedbackForm.feedbackMsg.value;
        var action;

        if (lastname === "") {

            document.getElementById("feedbackMsg").style.borderColor = "#ff0000";
            action = false;

        }
        else {

            document.getElementById("feedbackMsg").style.borderColor = "";
            action = true;
        }
