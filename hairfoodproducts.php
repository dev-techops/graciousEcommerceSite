<!-- Author: Nathan Shava
     ...
     Description: Hair Food Products
     Filename: hairfoodproducts.php
-->
<?php
...
<html lang="en">
<head>
    <title>Hair Food Products</title>
    <meta charset="UTF-8">
                                ...
                                if (isset($_POST["btnAddCartItem"])) {
                                    ...
                                    if (isset($_SESSION["shoppingCart"])) //Keeps track of the shopping cart
                                    {
                                        ...
                                        if (!in_array($_GET["cartProd"], $array_item_id)) {
                                            ...
                                            ?>
                                            <script>
                                                window.location.href = "hairfoodproducts.php"; //Refresh page
                                            </script>
                                            <?php
                                    ...
                                    if ($_GET["action"] == "remove") //When customer clicks on the delete icon in the cart
                                    {
                                        foreach ($_SESSION["shoppingCart"] as $items => $values) {
                                            if ($values["product_item"] == $_GET["removeFromCart"]) {
                                                ...
                                                ?>
                                                <script>
                                                    window.location.href = "hairfoodproducts.php"; //Refresh
                                                </script>
                                                <?php
                                            }
                                        }
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf1['product_id']; ?>">
                    ...
                    while ($hf2 = mysqli_fetch_assoc($hairFood2)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf2['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <input type="hidden" name="hiddenprodqty" id="hiddenprodqty"
                                               value="1">
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf2["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
                    ...
                    while ($hf3 = mysqli_fetch_assoc($hairFood3)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf3['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf3["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
                    ...
                    while ($hf4 = mysqli_fetch_assoc($hairFood4)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf4['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf4["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
                    ...
                    while ($hf5 = mysqli_fetch_assoc($hairFood5)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf5['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf5["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
                    ...
                    while ($hf6 = mysqli_fetch_assoc($hairFood6)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf6['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf6["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
                    ...
                    while ($hf7 = mysqli_fetch_assoc($hairFood7)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post" name="cartBtnFrm" id="cartBtnFrm"
                                      action="hairfoodproducts.php?action=add&cartProd=<?php echo $hf7['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                                        ...
                                        <div style="padding-bottom:15%;background-color:#ffffff;">
                                            <p style="text-align:center;margin-top:2%;font-size:22pt;color:#4d0099;">
                                                <b>ZAR <?php echo $hf7["product_price"]; ?></b></p>
                                            <button style="margin-top:2em;margin-left:4em;" type="submit"
                                                    onclick="addToCart()"
                                                    id="btnAddCartItem"
                                                    name="btnAddCartItem"
