<!-- Author: Nathan Shava
     ...
     Description: Hair Relaxer Products
     Filename: relaxerproducts.php
-->
<?php
...
<html lang="en">
<head>
    <title>Hair Relaxer Products</title>
    <meta charset="UTF-8">
                                ...
                                if (isset($_POST["btnAddCartItem"])) {
                                    ...
                                    if (isset($_SESSION["shoppingCart"])) //Keeps track of the shopping cart
                                    {
                                        ...
                                        if (!in_array($_GET["cartProd"], $array_item_id)) {
                                            ...
                                            ?>
                                            <script>
                                                window.location.href = "relaxerproducts.php"; //Refresh page
                                            </script>
                                            <?php
                                    ...
                                    if ($_GET["action"] == "remove") //When customer clicks on the delete icon in the cart
                                    {
                                        foreach ($_SESSION["shoppingCart"] as $items => $values) {
                                            if ($values["product_item"] == $_GET["removeFromCart"]) {
                                                ...
                                                ?>
                                                <script>
                                                    window.location.href = "relaxerproducts.php"; //Refresh
                                                </script>
                                                <?php
                                            }
                                        }
                    ...
                    while ($hr1 = mysqli_fetch_assoc($hairRelaxer1)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr1['product_id']; ?>">
                    ...
                    while ($hr2 = mysqli_fetch_assoc($hairRelaxer2)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr2['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr3 = mysqli_fetch_assoc($hairRelaxer3)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr3['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr4 = mysqli_fetch_assoc($hairRelaxer4)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr4['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr5 = mysqli_fetch_assoc($hairRelaxer5)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr5['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr6 = mysqli_fetch_assoc($hairRelaxer6)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr6['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr7 = mysqli_fetch_assoc($hairRelaxer7)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr7['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr8 = mysqli_fetch_assoc($hairRelaxer8)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr8['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
                    ...
                    while ($hr9 = mysqli_fetch_assoc($hairRelaxer9)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="relaxerproducts.php?action=add&cartProd=<?php echo $hr9['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
