...
<div class="bg0 p-t-95 p-b-100">
    <div class="container">
        <form name="resetFrm" id="resetFrm" method="post" action="passwordReset.php">
            <p class="txt-s-101 cl9 p-b-17">
                Lost your password? Please enter the email address you used to register and you will receive a link to
                reset your password.
            </p>
            ...
            <div class="p-b-20">
                ...
                <input class="txt-s-101 cl3 size-a-41 bo-all-1 bocl15 p-rl-15 focus1" type="email" id="emailAdd"
                       name="emailAdd">
            </div>

            <div class="flex-w">

                <button type="button" id="btnReset" name="btnReset" onclick="validateForm()"
                        class="flex-c-m txt-s-105 cl0 bg10 size-a-40 hov-btn2 trans-04 p-rl-10 m-r-18">
                    Reset password
                </button>
            </div>
        </form>
...
<script>
    ...
    function validateEmail() {
        ...
        var email = document.resetFrm.emailAdd.value;
        var action;
