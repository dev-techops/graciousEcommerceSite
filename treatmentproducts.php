<!-- Author: Nathan Shava
     ...
     Filename: treatmentproducts.php
-->
<?php
...
<html lang="en">
<head>
    <title>Oil Treatment Products</title>
    <meta charset="UTF-8">
                                ...
                                if (isset($_POST["btnAddCartItem"])) {
                                    ...
                                    if (isset($_SESSION["shoppingCart"])) //Keeps track of the shopping cart
                                    {
                                        ...
                                        if (!in_array($_GET["cartProd"], $array_item_id)) {
                                            ...
                                            ?>
                                            <script>
                                                window.location.href = "treatmentproducts.php"; //Refresh page
                                            </script>
                                            <?php
                                    ...
                                    if ($_GET["action"] == "remove") //When customer clicks on the delete icon in the cart
                                    {
                                        foreach ($_SESSION["shoppingCart"] as $items => $values) {
                                            if ($values["product_item"] == $_GET["removeFromCart"]) {
                                                ...
                                                ?>
                                                <script>
                                                    window.location.href = "treatmentproducts.php"; //Refresh
                                                </script>
                                                <?php
                                            }
                                        }
                    ...
                    while ($t1 = mysqli_fetch_assoc($treatment1)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="treatmentproducts.php?action=add&cartProd=<?php echo $t1['product_id']; ?>">
                    ...
                    while ($t2 = mysqli_fetch_assoc($treatment2)) {
                        ...
                        <div class="block1">
                            <div class="block1-bg wrap-pic-w bo-all-1 bocl12 hov3 trans-04">
                                ...
                                <form method="post"
                                      action="treatmentproducts.php?action=add&cartProd=<?php echo $t2['product_id']; ?>">
                                    <div class="form-group">
                                        <input type="hidden" name="hiddenprodbrand" id="hiddenprodbrand"
